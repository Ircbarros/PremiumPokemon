...
class Game:
    ...
    def load_data(self):
        ...
        self.pokebolas_count = POKEBOLAS_QTD
    ...
    def quit(self):
        ...
        Returns:
            ...
            Quit the Game
        '''
        self.write_stdin_once()
        pg.quit()
        sys.exit()

    def write_stdin_once(self):
        '''
        Method responsible to write the number of caught 

        Returns:

            The unique number of pokebolas writed at the stdout
        '''
        global POKEBOLAS_QTD
        return sys.stdout.write(str(POKEBOLAS_QTD))
